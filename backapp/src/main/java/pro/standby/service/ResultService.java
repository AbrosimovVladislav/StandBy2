...
public class ResultService {
  ...
  public List<OverallResultItem> getOverallResultsById(Long id) {
  ...
  public List<StageViewResult> getStageViewResultsById(Long competitionId) {
  ...
  public List<CompetitorViewResult> getCompetitorViewResultsById(Long competitionId) {
    Competition competition = competitionService.findById(competitionId);
